...
# subset to common genes, sometimes combines sces function gives an error if we dont subset first 
sce_raws <- intersect_all(sce_raws)
sce_qcs <- intersect_all(sce_qcs)
...
# function makes a table with the median values
