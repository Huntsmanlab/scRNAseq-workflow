...
for(i in 1:length(dh_organoid_ids)){
  ...
  sce_qcs[[i]] <- make_sce_qc(whichMethod=params$whichMethod, sce=sce_raws[[i]], mito_thresh_max=params$mito_thresh_max, 
                              ...
                              nmads=params$nmads, min_features=params$min_features, remove_mito_and_ribo=params$remove_mito_and_ribo, save_qc="", qc_path="")
}
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 5, fig.width = 10, eval=FALSE, eval=FALSE}
