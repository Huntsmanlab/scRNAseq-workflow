---
title: '`r params$ids` Comparing high grade serous (HGS) endometrial and ovarian  tumors'
subtitle: 
author: "aslı"
...
params:
  ids_1: 'VOA11068_ENOC-DH13-DH18'
  ids_2: 'DH15-DH16'
  seed: 1234567
---

#### In this document, we compare the DGE in ovarian HGS and endometrial HGS tumors.  
VOA11068_ENOC-DH13-DH18-DH13 contain the data for ovarian tissues.  
DH15-DH16 contain the data for endometrial tissues.  
...
dh_organoid_ids_1 <- list(ids_1[[1]], ids_1[[2]], ids_1[[3]])

# load the integrated seurat object 
integrated_pair1 <- readRDS(here('..', 'data', 'clustered', 'combined', paste(dh_organoid_ids_1[[1]], dh_organoid_ids_1[[2]], dh_organoid_ids_1[[3]], sep = '-'), 'integrated_seurat_object.rds'))
...
combined_ova <- readRDS(here('..', 'data', 'clustered', 'combined', paste(dh_organoid_ids_1[[1]], dh_organoid_ids_1[[2]], dh_organoid_ids_1[[3]], sep = '-'), 'uncorrected_seurat_object.rds'))
...
#### ovarian HGS tumors: VOA11068_ENOC-DH13-DH18-DH13  
##### before batch correction  
``` {r echo = FALSE, message = FALSE, fig.height = 4, fig.width = 11}
...
#### endometrial HGS tumors: DH15-DH16  
##### before batch correction
...
The blue lines indicate 1-fold up or down. The number of genes that are significantly up or down regulated are shown in the table, according to the plot. Here, we compare the HGS endometrial tumors to HGS ovarian tumors. 
...
Fold change cut off is 0.5, p value cut off is 10e-3.  
