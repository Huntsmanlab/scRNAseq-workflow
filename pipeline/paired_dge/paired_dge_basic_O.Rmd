...
author: "Maxwell Douglas and Asli Munzur and Chris Horan"
...
params:
  ...
  ins: '/huntsman/general/data/clustered/sce/DH23/sce_clus.rds'
...
plot_markers <- function(inputs, ids, ntop = 50, negative_control = FALSE, randomSubsets = 100){
  ...
  if (length(strsplit(inputs, "-")[[1]]) == 1) {
    ...
    if(is.null(rowData(sce)$qc_pass)) {
      sce <- gene_filter(sce, gene_min_counts = 100, gene_min_detection_rate = 5, reporters = "eGFP") }
  } else {
