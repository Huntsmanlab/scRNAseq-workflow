...
params:
  ...
  ins: '/huntsman/amunzur/data/clustered/sce/cedarsSinai_lawrenson/H12/sce_clus_subset.rds-/huntsman/amunzur/data/clustered/sce/cedarsSinai_lawrenson/G12/sce_clus_subset.rds'
  ...
  output_path: '/huntsman/amunzur/data/dge/paired_dge_basic/cedarsSinai_lawrenson'
  # INSTRUCTIONS: Name of the output data file
  output_file: 'dge_output.rds'
  
  pathwayHmark: '/huntsman/minhbui/dh_organoid/data/gene_enrichment/input/h.all.v6.2.symbols.gmt'
  pathwayGO: '/huntsman/minhbui/dh_organoid/data/gene_enrichment/input/c5.all.v6.2.symbols.gmt'
  pathwayReact: '/huntsman/minhbui/dh_organoid/data/gene_enrichment/input/c2.cp.reactome.v7.0.symbols.gmt'
