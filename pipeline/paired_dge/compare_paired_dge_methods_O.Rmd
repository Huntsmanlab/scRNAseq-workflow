...
This script will compare the DE genes found by two DGE analysis scripts: scran and edgeR. 
It will separate the genes found in these two scripts into two categories: up and down regulated genes. 
Besides showing the common genes in both, it will also show the logFC and p values for both.  
...
# this one is saving the common up regulated genes found by both edger and scran:
write.csv(common_up_organized, file = here('..', 'data', 'dge', 'compare_dge_methods', 'upregulated_genes', paste(params$ids)))

# same thing for the down regulation 
write.csv(common_down_organized, file = here('..', 'data', 'dge', 'compare_dge_methods', 'downregulated_genes', paste(params$ids)))
```

Table for the **up** regulated genes in the transduced sample: 
```{r echo = FALSE, message = FALSE}

# show the tables we made earlier 
DT::datatable(common_up_organized, 
  extensions = 'Buttons', 
...
Table for the **down** regulated genes in the transduced sample: 
```{r echo = FALSE, message = FALSE}

# show the tables we made earlier 
DT::datatable(common_down_organized, 
  extensions = 'Buttons', 
  options = list(dom = 'Bfrtip', 
                 buttons = list("copy", "excel", "csv", "pdf")))
```
