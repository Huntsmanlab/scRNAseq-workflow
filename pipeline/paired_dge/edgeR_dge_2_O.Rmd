...
# make the DGE object 
dgeObject <- DGEList(counts = counts, group = factor(c(1, 2)))
...
designMatrix <- matrix(data = c(0, 0, 0, 1), ncol = 2, nrow = 2, dimnames = list(c('sample1', 'sample2'), c('control', 'treatment')))
...
temporary <- estimateDisp(dgeObject1[housekeeping_indices, ], trend="none", tagwise=FALSE)
