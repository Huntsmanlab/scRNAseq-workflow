...
if (length(ids_2) + length(ids_1) >= 4) {
  ...
  path_list <- as.list(unlist(strsplit(params$seurat_integ[[1]], ' '))) 
  
  # load the objects 
  integrated_pair1 <- readRDS(path_list[0])
  integrated_pair2 <- readRDS(path_list[1])
  ...
  message(print(path_sample1))
  message(print(path_sample2))
