...
ids_1 <- strsplit(ids_1_name, "-")[[1]]
dh_organoid_ids_1 <- list(ids_1)
ids_1 <- as.list(c(unlist(dh_organoid_ids_1)))

ids_2_name <- strsplit(params$ids, "=")[[1]][[2]] # split by "%" 
ids_2 <- strsplit(ids_2_name, "-")[[1]]
dh_organoid_ids_2 <- list(ids_2)
ids_2 <- as.list(c(unlist(dh_organoid_ids_2)))
...
if (length(ids_2) + length(ids_1) >= 4) {
  ...
  # extract assay data 
  integrated_pair1_df <- as.data.frame(GetAssayData(integrated_pair1))
  integrated_pair2_df <- as.data.frame(GetAssayData(integrated_pair2))
