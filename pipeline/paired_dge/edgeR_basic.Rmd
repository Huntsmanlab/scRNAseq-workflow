...
### Diagnostic Plots 
These plots are intended to give an idea about the model and whether it is a good fit to represent the data we are interested in analyzing. Make sure to check the dimensionality reduction reports as well. 
