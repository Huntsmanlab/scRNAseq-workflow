...
sample1_non_zero <- rowSums(counts_df[[1]])
sample2_non_zero <- rowSums(counts_df[[2]])
...
#MEANS 
sample1_non_zero_mean <- rowMeans(counts_df[[1]])
sample2_non_zero_mean <- rowMeans(counts_df[[2]])
