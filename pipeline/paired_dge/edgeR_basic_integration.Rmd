...
if (length(ids_1_split) + length(ids_2_split) >= 4) {
  ...
  integrated_pair1 <- readRDS(here('..', 'data', 'integrated', paste(ids_1_name), 'integrated.rds'))
  integrated_pair2 <- readRDS(here('..', 'data', 'integrated', paste(ids_2_name), 'integrated.rds'))
