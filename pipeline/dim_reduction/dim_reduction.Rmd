...
sce_norm <- runTSNE(sce_norm, dimred = "PCA", exprs_values = "logcounts", ncomponents = 3)
...
message(print("Computing diffusion map coordinates. This may take a while depending on how large your SCE object is, up to 10 minutes."))
