...
params:
  pair_ids: 'pair_ids'
  sce_clus: 'sce_clus'
  cell_cycle_species: 'cell_cycle_species'
  sce_cell_cycle: 'sce_cell_cycle'
  sce_cell_cycle_corrected: 'sce_cell_cycle_corrected'
...
sce_cell_cycle <- as.list(unlist(strsplit(params$sce_cell_cycle[[1]], ' '))) 
sce_cell_cycle_corrected <- as.list(unlist(strsplit(params$sce_cell_cycle_corrected[[1]], ' '))) 
