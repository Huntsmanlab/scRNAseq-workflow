...
sce_cell_cycle <- lapply(ids, function(id) here('..', 'data', 'cell_cycle', id, 'cell_cycle_label.rds'))
sce_cell_cycle_corrected <-  lapply(ids, function(id) here('..', 'data', 'cell_cycle', id, 'cell_cycle_corrected.rds'))
