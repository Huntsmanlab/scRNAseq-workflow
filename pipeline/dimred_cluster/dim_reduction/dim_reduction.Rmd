...
Significant PCs will show a curve that is strongly skewed to the left compared to the null distribution (dashed line). A subset of the data (1% by default) was randomly permuted and PCA was computed again. This constructs a 'null distribution' of feature scores where the procedure was repeated numerous times.
...
JackStrawPlot(object = sobject, dims = 1:20, reduction = "pca") + labs(x="Empirical Quantile", y="Theoretical Quantile")
