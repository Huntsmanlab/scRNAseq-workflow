...
#### Batch effects, such as samples taken from different from patients or conditions cells kept in (frozen or fresh) can introduce unwanted technical variation to the replicates. Here we show some dimensionality reduction plots to help understand the extent of batch effects on the samples, before we do any correction. 

##### ovarian endometrioid tumors: DH8-DH24 
##### ovarian endometrioid tumors: DH4-DH17 
...
### Here we show some dimensionality reduction plots to help judge whether the samples mentioned above are  
similar enough to be considered as replicates, AFTER BATCH CORRECTION.
...
This table compares endometrioid endometrial tumors to endometrioid ovarian tumors. 
...
Note that we compare endometrioid endometrial tumors to endometrioid ovarian tumors. 
```{r echo = FALSE, message = FALSE}
