...
params:
  pair_ids: 'DH22_NEW-DH22_control' # write here the ids you want to integrate, separate by '-'
...
sce_cas_path <- lapply(id.list, function(id) here('..', 'data', 'cellassign', id, 'sce_norm_cas.rds'))
