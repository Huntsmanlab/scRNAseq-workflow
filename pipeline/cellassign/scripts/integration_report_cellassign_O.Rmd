...
params:
  pair_ids: 'DH35' # write here the ids you want to integrate, separate by '-'
...
#set.seed(123)
set.seed(6666) # 6666 is the seed number used in integration_report_cellassign.Rmd
...
#cell_types <- c("lymphocyte", "epithelial_unciliated", "epithelial_ciliated","endothelial", "stromal_fibroblast")
