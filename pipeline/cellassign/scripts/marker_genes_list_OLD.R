...
Epithelial_gene_symbols <- c('EPCAM', 'WFDC2', 'KLF5', 'SDC4', 'UCA1', 'TACSTD2', 'LINC01541', 'ELF3', 'C1orf186', 'DSP', 'CLDN4', 'PERP', 'KRT18', 'CD9', 'USP53')
...
Epithelial_ciliated_gene_symbols <- c('C20orf85', 'TPPP3', 'TUBA1A', 'RSPH1', 'TUBB4B', 'C9orf24', 'IGFBP7', 'C5orf49', 'PIFO', 'OMG', 'FOXJ1', 'DYDC2', 
                                      "SNTN", "WDR16", "FAM92B", "C20orf85", "TPPP3", "C9orf24", "OMG", "IGFBP7", "FAM183A", "RSPH1")
