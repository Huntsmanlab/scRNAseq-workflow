# This script is for integrating multiple data sets with cell assign information 
...
parser$add_argument('--path_to_sce_cas', metavar='DIRECTORY', type='character',
...
integrate <- function(path_to_sce_cas, 
                      path_to_sce_norm, 
...
integrate(path_to_sce_cas = args$path_to_sce_cas, 
